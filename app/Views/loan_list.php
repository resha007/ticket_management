...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>LS Lanka</span>Micro Credit</a>
				<ul class="user-menu">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
							...
							<div class="col-md-12">
								<form role="form" form method="post" id="loanForm">
									...
									<div class="form-group col-md-6">
										...
										<input class="form-control" name="guarantor_1" id="guarantor_1">
										<!-- <select class="form-control" name="guarantor_1" id="guarantor_1">
									...
									<div class="form-group col-md-6">
										...
										<input class="form-control" name="guarantor_2" id="guarantor_2">
										<!-- <select class="form-control" name="guarantor_2" id="guarantor_2">
											<option value="0">Select here</option>
										    <option value="1">Admin</option>
											<option value="2">Rider</option> -->
										<!-- </select> --> 
									...
									<div class="form-group col-md-4">
										...
										<input class="form-control" name="created_by" id="created_by">
                                        <!-- <select class="form-control" name="created_by" id="created_by" placeholder="Select here">
										    <option value="1">Admin</option>
											<option value="2">Rider</option>
										</select> -->
									</div>
									...
									<div class="form-group col-md-4">
										...
										<input class="form-control" name="approved_by" id="approved_by">
										<!-- <select class="form-control" name="approved_by" id="approved_by" placeholder="Select here">
										    <option value="1">Admin</option>
											<option value="2">Rider</option>
										</select> -->
									</div>
									...
									<!-- <div class="form-group col-md-12">
										<button type="submit" class="btn btn-primary" id='add'><span class="">Proceed</button>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Loan Time Period with The Amount</div>
					<div class="panel-body">
						<table data-toggle="table" data-url="employee/get"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
								<thead>
								<tr>
									<th data-field="date_due" data-checkbox="true" id="date_due">Date Due</th>
									<th data-field="final_amount" data-sortable="true" id="final_amount">Amount(With the interest)</th>
									<th data-field="date_paid"  data-sortable="true" id="date_paid">Date Paid</th>
									<th data-field="updated by" data-sortable="true" id="updated by">Updated by</th>
									<th data-field="delete"  data-sortable="true" id="delete">Delete</th>
